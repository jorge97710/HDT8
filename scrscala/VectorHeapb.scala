...
class VectorHeapb[E <: Comparable[E]] extends PriorityQueue[E] {
  ...
  override def getFirst(): E = data.elementAt(0)

  override def isEmpty(): Boolean = data.size == 0
